...
<body>
    ...
    <img class="frankie" src="./assets/Images/frankesinstein.png">


    <div class="content">
        <section id="primary">
            <div class="logo-gray">
                <img src="./assets/Logo/logo_on_left.png">
            </div>
            <!-- Image of the week -->
            ...
            <div class="title-week">
                ...
                <div class="scroll-text">
                    ...
                    <img src="./assets/icon/icons8-telegram-96.png">
            ...
            <section id="image-of-week">
                <div class="slideshow">
                    <div class="photo">
                        <img src="./assets/Images/animated/slideshow1.jpg">
                    ...
                    <div class="photo">
                        <img src="./assets/Images/animated/slideshow2.jpg">
                    ...
                    <div class="photo slide">
                        <img src="./assets/Images/animated/slideshow3.jpg">
                    ...
                    <div class="photo slide">
                        <img src="./assets/Images/animated/slideshow4.jpg">
                    ...
                    <div class="photo slide">
                        <img src="./assets/Images/animated/slideshow5.jpg">
            ...
            <section class="film-section">
                ...
                <div id="first-film">
                    ...
                    <div class="left-container">
                        ...
                        <svg width="64" height="64" class="arrow">
                            <image href="assets/icon/arrow_forward_24dp_FILL0_wght400_GRAD0_opsz24.svg" width="64"
                                height="64"></image>
                        </svg>
                    </div>
                </div>
                ...
                <div id="second-film">
                    ...
                    <div class="right-container">
                        ...
                        <svg width="64" height="64" class="arrow">
                            <image href="assets/icon/arrow_back_24dp_FILL0_wght400_GRAD0_opsz24.svg" width="64"
                                height="64">
                            </image>
                        </svg>
                        <div class="trailer">
